...
- In a terminal, navigate to `CoreBotWithTestsExample`

    ```bash
    # change into project folder
    cd CoreBotWithTestsExample
    ```
...
- Run the bot from a terminal or from Visual Studio, choose option A or B.
  ...
  - Navigate to `CoreBotWithTestsExample` folder
  - Select `CoreBotWithTestsExample.csproj` file
